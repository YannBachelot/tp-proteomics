...
```
L'approche Shotgun proteomics est une approche bottom-up (on prend un échantillon qu'on digère).
```

##### Quel est l’objectif de cette approche ?

```
L'objectif est d'identifier des protéines par spectrométrie de masse
```
